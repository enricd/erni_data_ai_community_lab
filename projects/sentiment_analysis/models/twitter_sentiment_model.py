...
class TwitterSentimentAnalyzer():
    ...
    def data_cleaning(self):
        ...
        self.data['text_lang']=self.plain_text.apply(detect_language)
    ...
    def sentiment_analysis(self):
        for index, row in self.data['plain_text'].items():
            ...
            self.data.loc[index, 'Negative'] = neg
            self.data.loc[index, 'Neutral'] = neu
            self.data.loc[index, 'Positive'] = pos
    ...
    def get_top_n_gram(self, ngram_range,n=None):
        vec = CountVectorizer(ngram_range=ngram_range,stop_words = 'english').fit(self.data['plain_text'])
